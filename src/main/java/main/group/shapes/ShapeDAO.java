...
public class ShapeDAO {
    ...
    private SessionFactory buildSessionFactory(String configFileName) {
        try {
            ...
            metadataSources.addAnnotatedClass(Circle.class);
            metadataSources.addAnnotatedClass(ShapeExt.class);
    ...
    public void save(ShapeExt shape) {
    ...
    public void update(ShapeExt shape) {
        Transaction transaction = null;
        Session session = null;
        try {
            session = sessionFactory.openSession();
    ...
    public void delete(ShapeExt shape) {
        Transaction transaction = null;
        Session session = null;
        try {
            session = sessionFactory.openSession();
    ...
    public <T extends ShapeExt> T findById(Long id, Class<T> clazz) {
        Session session = null;
        try {
            session = sessionFactory.openSession();
    ...
    public <T extends ShapeExt> List<T> findAll(Class<T> clazz) {
        Session session = null;
        try {
            session = sessionFactory.openSession();
